...
<body>
  <div class="main-login">
    <div class="left-login">
      ...
      <img src="<?php echo base_url() ?>assets/img/Site-Stats-rafiki.svg" class="left-login-image"
        alt="Map-OS - Versão: <?= $this->config->item('app_version'); ?>">
    </div>
    <div id="loginbox">
          ...
          <div class="card">
            <div class="content">
              <div id="newlog">
                ...
                <div class="title01">
                  <?= '<img src="' . base_url() . 'assets/img/logo/studio_logo (1).png">'; ?>
                </div>
              </div>
              <div id="mcell">Versão:
              ...
              <form action="index.html" method="post">
                ...
                <div class="links-uteis"><a href="https://github.com/RamonSilva20/mapos">
                    <p>
                      <?= date('Y'); ?> &copy; Ramon Silva
                    </p>
                  </a>
                </div>
                <a href="#notification" id="call-modal" role="button" class="btn" data-toggle="modal"
                  style="display: none ">notification</a>
                <div id="notification" class="modal hide fade" tabindex="-1" role="dialog"
                  ...
                  <div class="modal-body">
                    <h5 style="text-align: center" id="message">Os dados de acesso estão incorretos, por favor tente
                      novamente!</h5>
                  </div>
